...
memberRoutes.get('/history', isLoggedIn,getHistory) // Get user's history from most recent 3 months
memberRoutes.get('/lentHistory', isLoggedIn,getLentHistory) // Get user lent history
memberRoutes.get('/borrowedHistory', isLoggedIn,getBorrowedHistory) // Get user borrowed history
memberRoutes.get('/allHistory', isLoggedIn, getAllHistory) // Get user's all time history
